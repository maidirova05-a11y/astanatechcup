...
const SAVED: Record<string, string> = {
  ...
  row: "Результат записан.",
  team_updated: "Команда исправлена — все таблицы уже показывают новые данные.",
  run: "Результат попытки сохранён.",
  bracket: "Сетка сформирована.",
};
...
const ERRORS: Record<string, string> = {
  ...
  bracket: "Проверьте выбранные команды и группу.",
  too_few_teams: "Нужно как минимум две команды, чтобы сформировать сетку.",
  already_scheduled:
    "В этой группе или на этой стадии уже есть матчи. Удалите незаполненные протоколы, если хотите пересобрать сетку.",
  slot: "В этом слоте сетки ещё нет команды — победителя назначить нельзя.",
  csrf: "Сессия устарела. Обновите страницу и повторите.",
  run_cell:
    "Не удалось прочитать попытку. Время — как 31.075 или 1:02.340, очки — целым числом, либо DNF / DSQ / FOUL. Пустая клетка удаляет попытку.",
};
